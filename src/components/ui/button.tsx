...
function Button({
  ...
  // When `render` is provided (e.g., to render as a Link/anchor), opt out of
  // the native <button> requirement that base-ui enforces by default.
  const resolvedNative = nativeButton ?? !render;
  return (
    <ButtonPrimitive
      data-slot="button"
